...
const items: CommandItem[] = [
  ...
  { id: "nav-mon-affaire", label: "Mon Affaire", href: "/mon-affaire", icon: Briefcase, group: "navigation", keywords: ["affaire", "scoring", "similarite"] },
  ...
  { id: "nav-conclusions", label: "Conclusions", href: "/conclusions", icon: ScrollText, group: "navigation", keywords: ["conclusions", "rapport", "export"] },
  { id: "nav-veille", label: "Veille juridique", href: "/veille", icon: Eye, group: "navigation", keywords: ["veille", "juridique", "alertes", "surveillance"] },
  // Quick actions
